...
import requests
root= Tk()
root.geometry('1270x690+120+75')
root.title('Restaurant Billing System mini project')
root.config(bg='LightBlue1')
topFrame=Frame(root,bd=10,relief='ridge',bg='brown')
topFrame.pack(side=TOP)
labelTitle=Label(topFrame,text='Restaurant Billing System',font=('arial',30,'bold'),fg='#1e3d59',bd=9,
                 bg='#f5f0e1',width=51)
labelTitle.grid(row=0,column=0)
                                                        #Frames

menuFrame=Frame(root,bd=10,relief=RIDGE,bg='brown')
menuFrame.pack(side=LEFT)

costFrame=Frame(menuFrame,bd=4,relief=RIDGE,bg='#f5f0e1',pady=10)
costFrame.pack(side=BOTTOM)

foodFrame=LabelFrame(menuFrame,text='Foods',font=('arial',19,'bold'),bd=10,relief=RIDGE,fg='#1e3d59',bg='#f5f0e1')
foodFrame.pack(side=LEFT)

drinksFrame=LabelFrame(menuFrame,text='Drinks',font=('arial',19,'bold'),bd=10,relief=RIDGE,fg='#1e3d59',bg='#f5f0e1')
drinksFrame.pack(side=LEFT)

cakesFrame=LabelFrame(menuFrame,text='Cakes',font=('arial',19,'bold'),bd=10,relief=RIDGE,fg='#1e3d59',bg='#f5f0e1')
cakesFrame.pack(side=LEFT)

rightFrame=Frame(root,bd=15,relief=RIDGE,bg='brown')
rightFrame.pack(side=RIGHT)

calculatorFrame=Frame(rightFrame,bd=1,relief=RIDGE,bg='brown')
calculatorFrame.pack()

recieptFrame=Frame(rightFrame,bd=4,relief=RIDGE,bg='brown')
recieptFrame.pack()

buttonFrame=Frame(rightFrame,bd=3,relief=RIDGE,bg='brown')
buttonFrame.pack()
                                                        #Variables
...
def send():
    if textReceipt.get(1.0,END)=='\n':
        ...
        def send_msg():
            ...
            auth='5O72IKr0NwCTjMgXahWetil6EcYfkGRzJF1LyVBnb3QPZHus94tAnjz1yqmNpvs2dQHUX8lGTSDEJK0W'
            url = "https://www.fast2sms.com/dev/bulkV2"
            querystring = {"authorization": "5O72IKr0NwCTjMgXahWetil6EcYfkGRzJF1LyVBnb3QPZHus94tAnjz1yqmNpvs2dQHUX8lGTSDEJK0W", "message": message, "language": "english",
...
labelCostofFood=Label(costFrame,text='Cost of Food',font=('arial',16,'bold'),bg='#f5f0e1',fg='#1e3d59')
...
labelCostofDrinks=Label(costFrame,text='Cost of Drinks',font=('arial',16,'bold'),bg='#f5f0e1',fg='#1e3d59')
...
labelCostofCakes=Label(costFrame,text='Cost of Cakes',font=('arial',16,'bold'),bg='#f5f0e1',fg='#1e3d59')
...
labelSubTotal=Label(costFrame,text='Sub Total',font=('arial',16,'bold'),bg='#f5f0e1',fg='#1e3d59')
labelSubTotal.grid(row=0,column=2)

textSubTotal=Entry(costFrame,font=('arial',16,'bold'),bd=6,width=14,state='readonly',textvariable=subtotalvar)
textSubTotal.grid(row=0,column=3,padx=41)

labelServiceTax=Label(costFrame,text='Service Tax',font=('arial',16,'bold'),bg='#f5f0e1',fg='#1e3d59')
...
labelTotalCost=Label(costFrame,text='Total Cost',font=('arial',16,'bold'),bg='#f5f0e1',fg='#1e3d59')
